...
func newStyles() styles {
	...
	return styles{
		...
		helpBar:      lipgloss.NewStyle().Foreground(muted).BorderTop(true).BorderForeground(border).MarginTop(1).PaddingTop(0),
		title:        lipgloss.NewStyle().Foreground(text).Bold(true),
		titleAccent:  lipgloss.NewStyle().Foreground(accentSoft).Bold(true),
		subtle:       lipgloss.NewStyle().Foreground(muted),
		panel:        lipgloss.NewStyle().Background(surface).Border(lipgloss.RoundedBorder()).BorderForeground(border).Padding(1, 1).MarginTop(1),
		panelActive:  lipgloss.NewStyle().Background(surface).Border(lipgloss.RoundedBorder()).BorderForeground(accentSoft).Padding(1, 1).MarginTop(1),
		...
		filter:      lipgloss.NewStyle().Foreground(text).Background(surfaceAlt).Padding(0, 1).MarginTop(1),
